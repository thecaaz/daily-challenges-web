...
namespace DailyChallenges.Migrations
{
    ...
    [Migration("20260716165536_AddUniqueSubmissionPerUserPerGamePerDay")]
    partial class AddUniqueSubmissionPerUserPerGamePerDay
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DailyChallenges.Models.FriendRequest", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("DailyChallenges.Models.Submission", b =>
                {
                    ...
                    b.HasIndex("UserId", "GameId", "ScoringDay")
                        .IsUnique()
            ...
            modelBuilder.Entity("DailyChallenges.Models.FriendRequest", b =>
                {
                    b.HasOne("DailyChallenges.Models.User", "Receiver")
                        .WithMany()
                        .HasForeignKey("ReceiverId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("DailyChallenges.Models.User", "Sender")
                        .WithMany()
